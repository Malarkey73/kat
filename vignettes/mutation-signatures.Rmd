...
Another mutational signature has received much attention since 2013 - Kataegis (from the Greek for "rainshower"). These localised bursts of mutation with a distinct TCW>TKW pattern result from the off-target deamination of nuclear DNA by the APOBEC3 family of enzymes (A3). The A3 enzymes true function is to deaminate the single stranded foreign DNA of various types of virus. Exactly how this goes wrong in cancer is a subject of continuing study - but it's become clear that this endoegenus self-harm is major source of the mutational burden underlying natural selection of driver mutations.
...
The package includes data from a breast cancer WGS SAMPLE retrieved from the COSMIC database and previously highlighted in the seminal kataegis paper: "*Mutational Processes Molding the Genomes of 21 Breast Cancers, Serena Nik-Zainal et al., Cell 149, 979–993, 2012*"
