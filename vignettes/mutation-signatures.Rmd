...
When data is read in via the read.mutations function it is given the class `VCF`. This is really just a data.frame/dplyr_tbl but with at least the 3 columns `chr`, `start.position`, `end.position` -- essentially just a checkpoint that the data is correctly formed.
